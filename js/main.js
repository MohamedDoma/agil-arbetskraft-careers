(() => {
  ...
  const translations = {
    sv: {
      ...
      'cards.itTitle': 'IT',
      'cards.logisticsTitle': 'Lager & Logistik (inga lediga jobb för tillfället)',
      'cards.constructionTitle': 'Bygg (inga lediga jobb för tillfället)',
      'cards.transportTitle': 'Transport',
      'cards.movingTitle': 'Flytt & Montage (inga lediga jobb för tillfället)',
    ...
    en: {
      ...
      'cards.itTitle': 'IT',
      'cards.logisticsTitle': 'Warehouse & Logistics (no open positions at the moment)',
      'cards.constructionTitle': 'Construction (no open positions at the moment)',
      'cards.transportTitle': 'Transport',
      'cards.movingTitle': 'Moving & Assembly (no open positions at the moment)',
